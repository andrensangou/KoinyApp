...
**Statut:** Publiée sur l'App Store (version 1.0.8). Version **1.0.9 build 1** uploadée sur App Store Connect le 21/05/2026 depuis la branche `feature/android-redesign` — inclut consentement marketing onboarding + FCM iOS push notifications (APNs configuré). En attente de review Apple.
**Android:** Version 1.0 versionCode 5 — AAB release uploadé en Tests fermés Alpha. Nécessite 12 testeurs × 14 jours pour accéder à la production. IAP Android à créer dans Play Console après passage en production.
