...
const LoginView: React.FC<LoginViewProps> = ({ data, onSelectChild, onParentAccess }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans transition-colors duration-500">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col min-h-[85vh] justify-between py-8">
        <div className="text-center mb-8">
          <div className="mx-auto w-40 h-40 bg-white dark:bg-slate-800 rounded-[3rem] flex items-center justify-center p-1 border-4 border-indigo-100 dark:border-slate-800 shadow-[0_20px_50px_-12px_rgba(99,102,241,0.3)] overflow-hidden animate-scale-in transition-all hover:scale-110 duration-300 mb-10">
            <img src="/mascot.png" alt="Koiny" className="w-full h-full object-contain mix-blend-multiply dark:mix-blend-normal transform scale-[1.35]" />
          </div>
